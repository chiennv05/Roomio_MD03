...
const EditInvoiceScreen = () => {
    ...
    const handleBackPress = () => {
        // Nếu có thay đổi, hỏi user có muốn lưu nháp không
        if (hasInvoiceChanged()) {
            showConfirm(
                ...
                "Xác nhận thoát",
                [
                    { text: 'Không lưu', onPress: () => navigation.navigate('Bill'), style: 'destructive' },
                    { text: 'Lưu nháp', onPress: () => handleSaveDraft(), style: 'default' },
                ]
            );
        } else {
