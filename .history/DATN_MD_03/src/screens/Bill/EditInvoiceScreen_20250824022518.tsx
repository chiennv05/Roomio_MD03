...
const EditInvoiceScreen = () => {
    ...
    useEffect(() => {
        if (selectedInvoice) {
            ...
            // Lưu trữ dữ liệu ban đầu để so sánh sau này (chỉ lần đầu)
            if (!initialInvoiceData.dueDate && !initialInvoiceData.note && initialInvoiceData.items.length === 0) {
    ...
    }, [selectedInvoice, initialInvoiceData]);
