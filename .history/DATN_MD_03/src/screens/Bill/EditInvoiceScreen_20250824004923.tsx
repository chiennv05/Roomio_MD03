            ...
            <ScrollView style={styles.scrollView}>
                ...
                {canEditInvoice() && (
                    <View style={styles.buttonGroup}>
                        {/* Test validation button - XOÁ SAU KHI TEST XONG */}
                        <TouchableOpacity
                            style={[styles.saveDraftButton, { backgroundColor: Colors.red }]}
                            onPress={() => {
                                const hasErrors = !validateAllInputs();
                                showAlert(hasErrors ? 'Có lỗi validation!' : 'Validation OK!');
                            }}>
                            <Text style={styles.saveDraftText}>Test Validation</Text>
                        </TouchableOpacity>
