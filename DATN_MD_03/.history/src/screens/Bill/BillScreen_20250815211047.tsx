...
const BillScreen = () => {
    ...
    useEffect(() => {
        ...
        if (startDateFilter || endDateFilter) {
            ...
            console.log('Filtered by date range:', startDateFilter?.toDateString(), '-', endDateFilter?.toDateString(), '- remaining:', allInvoices.length, '(removed', countBefore - allInvoices.length, ')');
        }
