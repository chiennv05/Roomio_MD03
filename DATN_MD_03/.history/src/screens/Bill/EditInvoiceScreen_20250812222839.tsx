...
const EditInvoiceScreen = () => {
    ...
    const getItemEditability = (item: InvoiceItem): {
        ...
        if (isStandardContractItem(item)) {
            ...
            // Chỉ cho phép chỉnh sửa đơn giá và chỉ số đồng hồ nếu là utility
                ...
                {invoiceItems.map((item, index) => {
                    ...
                    return (
                        <View key={item._id || index} style={styles.itemContainer}>
                            ...
                            {/* Show contract item badge for items from contract */}
                            {isStandardContractItem(item) && (
                                <View style={styles.customItemBadgeContainer}>
                                    <Text style={[styles.customItemBadge, { backgroundColor: '#FFF2E6', color: '#FF8C00' }]}>Từ hợp đồng</Text>
                                </View>
                            )}
                                ...
                                <View style={styles.itemPriceRow}>
                                    {editability.canEditUnitPrice ? (
                                        ...
                                        <View style={styles.readOnlyPriceContainer}>
                                            ...
                                            {isStandardContractItem(item) && (
                                                <Text style={styles.readOnlyNote}>Không thể chỉnh sửa</Text>
                                            )}
                                        </View>
                                    )}
