...
const BillDetailScreen = () => {
        ...
        return (
            <View style={styles.itemsContainer}>
                <View style={styles.itemsGrid}>
                    ...
                    // Tạo itemId duy nhất bằng cách kết hợp _id và index
                    const itemId = item._id ? `${item._id}-${index}` : `item-${index}`;
                    const isExpanded = expandedItems.has(itemId);
                    
                    // Debug: kiểm tra itemId được tạo
    ...
    const toggleItemExpanded = (itemId: string) => {
        ...
        console.log('Current expandedItems before:', Array.from(expandedItems));
        ...
        console.log('New expandedItems after:', Array.from(newExpandedItems));
