                                    ...
                                    <View style={styles.expandedDetails}>
                                        <View style={styles.detailItem}>
                                            ...
                                            <Text style={styles.detailItemValue}>
                                                {selectedInvoice?.period?.startDate ? formatDate(selectedInvoice.period.startDate) : 'N/A'}
                                            </Text>
                                        </View>
                                        <View style={styles.detailItem}>
                                            <Text style={styles.detailItemLabel}>Ngày kết thúc:</Text>
                                            <Text style={styles.detailItemValue}>
                                                {selectedInvoice?.period?.endDate ? formatDate(selectedInvoice.period.endDate) : 'N/A'}
                                            </Text>
                                        </View>
                                        <View style={styles.detailItem}>
