...
const BillScreen = () => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            {/* Nút Mẫu và Tạo hóa đơn cho chủ trọ */}
            {isLandlord && (
                <View style={styles.bottomButtonsContainer}>
                    ...
                    >
                        <Text style={styles.bottomButtonText}>Mẫu</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={styles.bottomButton}
                        onPress={handleCreateNewInvoice}
                    >
                        <Text style={styles.bottomButtonText}>Tạo hóa đơn</Text>
                    </TouchableOpacity>
                </View>
            )}
...
const styles = StyleSheet.create({
    ...
    flatListContent: {
        paddingBottom: 20, // Reduced padding since no FAB
