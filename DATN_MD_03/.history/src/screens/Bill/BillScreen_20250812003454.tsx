...
const BillScreen = () => {
    ...
    }, [dispatch, token, selectedStatus, isUserCoTenant, useIsFocused()]);
    ...
    const handleRefresh = useCallback(() => {
        ...
        refreshData();
    }, [dispatch, token, selectedStatus, isLandlord, user?.role, isUserCoTenant, useIsFocused()]);
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <LoadingOverlay 
                visible={useIsFocused() && loading && !isRefreshing}
