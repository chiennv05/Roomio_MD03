                ...
                <View style={styles.itemsGrid}>
                    {(() => {
                        ...
                        for (let i = 0; i < items.length; i += 2) {
                            ...
                            rows.push(
                                <View key={`row-${i}`} style={styles.itemsRow}>
                                    <TouchableOpacity style={styles.itemCard} activeOpacity={0.85} onPress={() => toggleItemExpanded(leftKey)}>
                                    ...
                                    {right && (
                                        <TouchableOpacity style={styles.itemCard} activeOpacity={0.85} onPress={() => rightKey && toggleItemExpanded(rightKey)}>
                                            <View style={styles.itemHeaderRow}>
                                                <View style={styles.itemIconContainer}>
