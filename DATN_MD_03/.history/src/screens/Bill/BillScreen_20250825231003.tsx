            ...
            if (user?.role === 'nguoiThue') {
                ...
                const checkAndLoadData = async () => {
                    try {
                        ...
                        console.log('🔄 Loading both invoice types for mixed display');

                        // THAY ĐỔI: Tải cả hai loại hóa đơn thay vì chỉ một loại
                        // Tải hóa đơn thường
                        dispatch(fetchInvoices({
                            token,
                            page: 1,
                        ...
                        // Tải hóa đơn roommate (nếu có quyền truy cập)
                        try {
                            ...
                            console.log('Cannot load roommate invoices:', roommateError);
                            // Không làm gì nếu không thể tải roommate invoices
                        }
