...
const styles = StyleSheet.create({
  ...
  bottomBar: { paddingHorizontal: 12, paddingVertical: 8 },
  bottomBarInner: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.black, borderRadius: 40, padding: 8 },
  closeCircle: { width: 64, height: 64, borderRadius: 32, backgroundColor: Colors.darkGray || '#222', alignItems: 'center', justifyContent: 'center' },
  closeText: { color: Colors.white, fontSize: 22, fontWeight: '700' },
  primaryCTA: { flex: 1, marginLeft: 12, backgroundColor: '#BAFD00', borderRadius: 32, paddingVertical: 18, alignItems: 'center' },
  primaryCTAText: { color: Colors.black, fontSize: 20, fontWeight: '800' },
});
