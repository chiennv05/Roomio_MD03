...
const styles = StyleSheet.create({
  ...
  noteWrapper: { flexDirection: 'row', alignItems: 'stretch', marginBottom: 16, gap: 12 },
  noteAccent: { width: 8, borderRadius: 4, backgroundColor: '#BAFD00' },
  noteBox: { flex: 1, backgroundColor: '#F1F1F1', borderRadius: 12, padding: 12 },
  ...
  closeText: { color: Colors.white, fontSize: 22, fontWeight: '700' },
