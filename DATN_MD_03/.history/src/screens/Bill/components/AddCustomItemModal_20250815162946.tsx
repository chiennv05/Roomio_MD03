...
const styles = StyleSheet.create({
  ...
  bottomBar: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 8 },
  closeCircle: { width: 64, height: 64, borderRadius: 32, backgroundColor: Colors.black, alignItems: 'center', justifyContent: 'center' },
  closeText: { color: Colors.white, fontSize: 22, fontWeight: '700' },
  primaryCTA: { flex: 1, marginLeft: 12, backgroundColor: '#BAFD00', borderRadius: 999, paddingVertical: 18, alignItems: 'center' },
