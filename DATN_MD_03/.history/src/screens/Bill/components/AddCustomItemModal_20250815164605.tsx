...
const styles = StyleSheet.create({
  ...
  flexItem: { flex: 1 },
  categoryButtons: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, justifyContent: 'space-between' },
  categoryButton: {
  ...
  noteAccent: { width: 12, borderRadius: 6, backgroundColor: Colors.limeGreen },
