...
const styles = StyleSheet.create({
  ...
  bottomBar: { paddingHorizontal: 16, paddingVertical: 8 },
  bottomBarInner: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.black, borderRadius: 50, padding: 8 },
  closeCircle: { width: 56, height: 56, borderRadius: 28, backgroundColor: Colors.darkGray || '#222', alignItems: 'center', justifyContent: 'center' },
  closeText: { color: Colors.white, fontSize: 20, fontWeight: '700' },
  primaryCTA: { width: '70%', marginLeft: 12, backgroundColor: '#BAFD00', borderRadius: 28, paddingVertical: 14, alignItems: 'center' },
