  ...
  return (
    <Modal visible={visible} animationType="slide" transparent>
      <View style={styles.modalBackdrop}>
        <View style={[styles.modalContainer, { paddingBottom: 80 + insets.bottom }]}>
...
const styles = StyleSheet.create({
  ...
  bottomBar: { paddingHorizontal: 16, paddingVertical: 6, position: 'absolute', bottom: 0, left: 0, right: 0 },
