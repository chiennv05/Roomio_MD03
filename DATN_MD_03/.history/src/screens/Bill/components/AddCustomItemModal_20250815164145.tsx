...
const AddCustomItemModal: React.FC<AddCustomItemModalProps> = ({ visible, loading = false, onClose, onSave, defaultValues }) => {
  ...
  // Bám sát mock: chỉ hiển thị Dịch vụ, Bảo trì, Khác
                ...
                {categories.map((c, idx) => (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      (idx < 2) && styles.categoryButtonHalf, // Dịch vụ & Bảo trì chia 2 cột
                      c === 'other' && styles.categoryButtonFullWidth, // Khác full width
...
const styles = StyleSheet.create({
  ...
  inputLabel: { color: Colors.black, marginBottom: 8, fontWeight: '800', fontSize: 16 },
  modalInput: {
    borderWidth: 1,
    borderColor: '#E8E8E8',
    borderRadius: 32,
  ...
  flexItem: { flex: 1 },
  categoryButtons: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  categoryButton: {
  ...
  categoryButtonHalf: { width: '48%' },
  categoryButtonActive: {
    backgroundColor: '#BAFD00',
    borderWidth: 0,
  },
  categoryButtonText: { color: Colors.black, fontWeight: '600' },
  ...
  noteWrapper: { flexDirection: 'row', alignItems: 'stretch', marginBottom: 18, gap: 12 },
  noteAccent: { width: 8, borderRadius: 4, backgroundColor: '#BAFD00' },
  noteBox: { flex: 1, backgroundColor: '#F3F3F3', borderRadius: 12, padding: 12 },
  ...
  checkboxBoxChecked: { backgroundColor: '#BAFD00', borderColor: '#000' },
  checkboxTick: { color: Colors.black, fontWeight: '900' },
  checkboxLabel: { color: Colors.black, fontSize: 16 },
  bottomBar: { paddingHorizontal: 16, paddingVertical: 10 },
  bottomBarInner: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.black, borderRadius: 50, padding: 10 },
  closeCircle: { width: 68, height: 68, borderRadius: 34, backgroundColor: Colors.darkGray || '#222', alignItems: 'center', justifyContent: 'center' },
  closeText: { color: Colors.white, fontSize: 24, fontWeight: '700' },
  primaryCTA: { flex: 1, marginLeft: 14, backgroundColor: '#BAFD00', borderRadius: 32, paddingVertical: 18, alignItems: 'center' },
  primaryCTAText: { color: Colors.black, fontSize: 22, fontWeight: '800' },
});
