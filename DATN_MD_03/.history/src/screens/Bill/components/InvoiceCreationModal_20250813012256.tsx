...
const InvoiceCreationModal: React.FC<InvoiceCreationModalProps> = ({
    ...
    useEffect(() => {
        ...
        if (!isDueDateValid(selectedDueDate, selectedDate)) {
            ...
            // Hiển thị thông báo
            showSuccess('Đã tự động cập nhật ngày hết hạn để phù hợp với ngày bắt đầu mới');
        }
    }, [selectedDate]);
            ...
            <View style={styles.modalContainer}>
                <View style={styles.modalContent}>
                    ...
                    <View style={styles.formSection}>
                        ...
                        <View style={styles.dateConstraintsInfo}>
                            <Text style={styles.dateConstraintsText}>
                                ⚠️ Lưu ý: Ngày hết hạn phải sau ngày bắt đầu và không quá 2 tháng
                            </Text>
                        </View>
...
const styles = StyleSheet.create({
    ...
    dateConstraintsInfo: {
        backgroundColor: Colors.lightYellow, // A light yellow background for constraints
        padding: responsiveSpacing(10),
        borderRadius: scale(8),
        marginTop: responsiveSpacing(10),
        marginBottom: responsiveSpacing(10),
    ...
    dateConstraintsText: {
        fontSize: responsiveFont(12),
        color: Colors.darkYellow, // A dark yellow color for constraints
        fontWeight: 'bold',
        textAlign: 'center',
    },
});
