                ...
                {invoiceItems.map((item, index) => {
                    ...
                    return (
                        <View key={item._id || index} style={styles.itemContainer}>
                            ...
                            {/* Description field - chỉ hiển thị khi có thể chỉnh sửa */}
                            ...
                            {/* Chỉ hiển thị item details khi có thể chỉnh sửa hoặc cần hiển thị thông tin */}
                            {(editability.canEditUnitPrice || editability.isEditable) ? (
                                <View style={styles.itemDetails}>
                                    <View style={styles.itemPriceRow}>
                                        {editability.canEditUnitPrice ? (
                                            ...
                                            // Chỉ hiển thị đơn giá khi không thể chỉnh sửa
