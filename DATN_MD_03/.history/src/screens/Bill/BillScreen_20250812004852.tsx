...
const BillScreen = () => {
    ...
    useFocusEffect(
        ...
        }, [dispatch, token, isLandlord, user?.role, selectedStatus, isFocused])
    );
    ...
    }, [dispatch, token, selectedStatus, isUserCoTenant, isFocused]);
    ...
    const handleRefresh = useCallback(() => {
        // Nếu không có token hoặc màn hình không được focus, không làm gì cả
        if (!token || !isFocused) {
            console.log('No token available for refresh or screen not focused');
            return;
        }
        ...
        refreshData();
    }, [dispatch, token, selectedStatus, isLandlord, user?.role, isUserCoTenant, isFocused]);
        ...
        return (
            <View style={styles.statusFilterContainer}>
                <ScrollView 
                    horizontal 
                    showsHorizontalScrollIndicator={false}
                    contentContainerStyle={styles.statusFilterScrollContainer}
                >
                        ...
                        return (
                            <TouchableOpacity
                                ...
                                style={[
                                    ...
                                    isSelected ? styles.statusFilterButtonSelected : styles.statusFilterButtonUnselected,
                                ]}
                                onPress={() => {
                                ...
                                <Text
                                    style={[
                                        ...
                                        isSelected ? styles.statusFilterButtonTextSelected : styles.statusFilterButtonTextUnselected,
                                    ]}>
                                    {item.label}
                                </Text>
                            </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    statusFilterButtonTextUnselected: {
        color: Colors.dearkOlive,
    },
});
