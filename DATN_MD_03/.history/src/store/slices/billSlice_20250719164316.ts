...
const billSlice = createSlice({
    ...
    extraReducers: builder => {
        builder
            ...
            .addCase(checkIsCoTenant.pending, (state) => {
                state.isCoTenantLoading = true;
                state.isCoTenantError = null;
            })
            .addCase(checkIsCoTenant.fulfilled, (state, action: PayloadAction<{isCoTenant: boolean, contracts: any[]}>) => {
                state.isCoTenantLoading = false;
            ...
            .addCase(checkIsCoTenant.rejected, (state, action) => {
                state.isCoTenantLoading = false;
