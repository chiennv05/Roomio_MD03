...
const RoomInfo: React.FC<RoomInfoProps> = ({
  ...
  return (
    <View style={styles.container}>
      {/* Giá */}
      <Text style={styles.priceText}>Mã phòng : {roomCode}</Text>
      ...
      <View style={styles.roomCodeContainer}>
        ...
        <Text style={styles.roomCode}>Giá tiền : {price}</Text>
      </View>
      ...
      {onMapPress && (
        <TouchableOpacity
          ...
          onPress={onMapPress}
          activeOpacity={0.7}>
          <Image source={{uri: Icons.IconMap}} style={styles.mapIconNew} />
